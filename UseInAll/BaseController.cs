...
{
    protected bool mouseClickUse = false;
    ...
    protected virtual void SendSwipe(SwipeDirection direction)
    {
        ...
        //Post on swipe event
        this.PostEvent(EventID.OnSwipe, swipeData);
    }

    protected virtual void SendClick()
    {
        if (!mouseClickUse) return;
        //Post on click event
        this.PostEvent(EventID.OnClick, upPosition);
    }
